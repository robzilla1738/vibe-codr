...
export interface HookPayloads {
  ...
  "subagent.start": { sessionId: string; subagentId: string; prompt: string; agent?: string };
  "subagent.stop": { sessionId: string; subagentId: string; result: string; failed?: boolean };
  "permission.denied": { sessionId: string; toolName: string; reason?: string };
  "compact.before": { sessionId: string };
  "compact.after": { sessionId: string; freedTokens: number };
  "goal.transition": { sessionId: string; from: string; to: string; reason?: string };
  "turn.failure": { sessionId: string; message: string };
}
