...
export const PROVIDER_RUNTIME_METADATA: ProviderRuntimeMetadata[] = [
  ...
  { id: "codex", env: ["CODEX_API_KEY", "OPENAI_API_KEY"], baseURL: "https://api.openai.com/v1", baseURLEnv: "CODEX_BASE_URL" },
  ...
  { id: "openai-codex", env: ["CODEX_API_KEY", "OPENAI_API_KEY"], baseURL: "https://chatgpt.com/backend-api/codex", baseURLEnv: "CODEX_BASE_URL" },
