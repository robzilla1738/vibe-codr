...
const desktopLock = [
  join(root, "apps", "desktop", "ENGINE_COMMIT"),
...
if (!expected) throw new Error("ENGINE_COMMIT is unavailable; set VIBE_ENGINE_COMMIT or restore apps/desktop/ENGINE_COMMIT");
