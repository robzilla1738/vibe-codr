...
execFileSync("docker", [
  ...
  [
    ...
    "    if (frame.channel === 'agent' && frame.type === 'ready' && frame.engineSessionId !== expectedSessionId) { clearTimeout(timer); reject(new Error(`cloud agent did not preflight the expected session: ${frame.engineSessionId}`)); }",
